...
RANDOM_STATE = 0
ADOPTED_MODE = "B"  # 1위와 무관하게 항상 B를 채택 배지에 붙인다
CLIP_LOWER_QUANTILE = 0.01
CLIP_UPPER_QUANTILE = 0.99
B_EQUALS_C_DECIMALS = 4  # 소수점 4자리까지 동일하면 "차이 없음"
